...
Java_com_nkming_nc_1photos_np_1platform_1image_1processor_processor_WhitePoint_applyNative(
...
extern "C" JNIEXPORT jbyteArray JNICALL
Java_com_nkming_nc_1photos_np_1platform_1image_1processor_processor_BlackPoint_applyNative(
    JNIEnv *env, jobject *thiz, jbyteArray rgba8, jint width, jint height,
    jfloat weight) {
  try {
    initOpenMp();
