...
class DonationBlocLoading extends DonationBlocState {
  const DonationBlocLoading(List<StoreProduct> products) : super(products);
}

class DonationBlocSuccess extends DonationBlocState {
  const DonationBlocSuccess(List<StoreProduct> products) : super(products);
}

class DonationBlocFailure extends DonationBlocState {
  const DonationBlocFailure(List<StoreProduct> products, this.exception)
      : super(products);
